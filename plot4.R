...
plot((inputdata$SecondsSinceEpoch - 22000), inputdata$Sub_metering_1, type = "l", xlab = "", ylab = "Energy Sub Metering", col = "black")
lines((inputdata$SecondsSinceEpoch - 22000), inputdata$Sub_metering_2, col = "red")
lines((inputdata$SecondsSinceEpoch - 22000), inputdata$Sub_metering_3, col = "blue")
legend(x = "topright", legend = c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), lwd = 1, col = c("black","red","blue"))
plot((inputdata$SecondsSinceEpoch - 22000), inputdata$Voltage, xlab = "datetime", ylab = "Voltage", type = "l")
plot((inputdata$SecondsSinceEpoch - 22000), inputdata$Global_reactive_power, xlab = "datetime", ylab = "Global_Reactive_Power", type = "l")
